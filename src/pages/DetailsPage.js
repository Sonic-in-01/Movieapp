    ...
    <div>
          ...
          <div className='container mx-auto px-3 py-16 lg:py-0 flex flex-col lg:flex-row gap-5 lg:gap-10 '>
              <div className='relative mx-auto lg:-mt-28 lg:mx-0 w-fit min-w-60'>
                  ...
                  /> 
                  <button onClick={()=>handlePlayVideo(data)} className='mt-3 w-full py-2 px-4 text-center bg-white text-black rounded font-bold text-lg hover:bg-gradient-to-l from-red-500 to-orange-500 hover:scale-105 transition-all'>Download Now</button>
              </div>
              ...
              <div>
                ...
                <div>
                    ...
                    <div className='flex items-center gap-3 my-3 text-center'>
                        ...
                        <span>|</span>
                        <p>
                          Release Date : {moment(data?.first_air_date).format("MMMM Do YYYY")}
                        </p>
                        <span>|</span>
                        <p>
                        Season : {Number(data?.seasons)}
                        </p>
                        <span>|</span>
                        <p>
